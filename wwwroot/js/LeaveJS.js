...
function yKZSDGYyOfLkUoB(t) {
    ...
    for (let i = 0; i < PXHhlPBPzXQFpVg.length; i++) 
    {
        ...
        {
            document.querySelector('.efUljXvyQujgoTu').innerHTML += `<div class="iLPhCPQLeZriLNQ"><div class="ctIBgsayAyonpQK">` + PXHhlPBPzXQFpVg[i].innerHTML + `<span>` + data + `</span>` + `</div><div class="jLWszVjseUnWpuM">`
